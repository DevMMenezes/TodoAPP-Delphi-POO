...
{ Exemplo:
  ...
  Control := frmLogin ( Qualquer componente );
}
...
procedure TShadowBox.Notification(AComponent: TComponent;
...
begin
  if FControl <> nil then
  begin
    SetBounds(FControl.Left - 8, FControl.Top - 8, FControl.Width + 16,
      FControl.Height + 16);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        case Color of
          $FFFFFF:
            rgbReserved := 0; // white = transparent
          $000000:
            rgbReserved := 255; // black = opaque
        else
          rgbReserved := 255 - ((rgbRed + rgbGreen + rgbBlue) div 3);
          // intensity of semi transparent
        end;
        rgbRed := Darkness;
        rgbGreen := Darkness;
        rgbBlue := Darkness; // darkness
...
begin
  ...
  try
    ...
    Windows.AlphaBlend(Canvas.Handle, // HDC hdcDest
      0, // int xoriginDest
      0, // int yoriginDest
